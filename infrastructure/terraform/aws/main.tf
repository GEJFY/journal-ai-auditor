# =============================================================================
# JAIA AWS Infrastructure
# =============================================================================
# AWS Bedrock (Claude Sonnet 4.6 Opus) を使用した監査AIシステム
#
# 使用方法:
...
variable "bedrock_model_id" {
  ...
  type        = string
  default     = "anthropic.claude-sonnet-4-6-opus-20260115-v1:0"
}
...
resource "aws_s3_bucket" "data" {
  bucket = "${var.app_name}-${var.environment}-data-${data.aws_caller_identity.current.account_id}"
...
resource "aws_secretsmanager_secret" "app_secrets" {
  ...
  description = "JAIA application secrets"
