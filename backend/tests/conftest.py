...
def sample_journal_entries() -> pl.DataFrame:
    ...
    data = {
        ...
        "source": ["SALES", "SALES", "SALES", "SALES", "MANUAL", "MANUAL", "AP", "AP", "AR", "AR"],
        "prepared_by": ["U001", "U001", "U002", "U002", "U001", "U001", "U003", "U003", "U001", "U001"],
        "approved_by": ["U002", "U002", "U003", "U003", "U001", "U001", "U001", "U001", "U002", "U002"],  # JE003は自己承認
        "approved_date": [
            date(2024, 4, 2), date(2024, 4, 2),
            date(2024, 5, 16), date(2024, 5, 16),
            date(2024, 6, 30), date(2024, 6, 30),
            date(2024, 6, 30), date(2024, 6, 30),
...
def sample_journal_entries_with_anomalies() -> pl.DataFrame:
    ...
    data = {
        ...
        "entry_time": [
            "23:58:00", "23:59:00",  # 営業時間外
            "02:30:00", "03:45:00",  # 深夜
            "09:00:00", "10:00:00",
            "11:00:00", "12:00:00",
            "13:00:00", "14:00:00",
        ],
        "gl_account_number": [
            "1131", "1131", "1111", "5999",  # 異常科目組み合わせ
            "1131", "1131", "1131", "1131",
            "1131", "1131",
        ],
        "amount": [
        ...
        "functional_amount": [
            100000000, 99999999, 1000000, 500000,
...
def sample_chart_of_accounts() -> list[dict]:
    ...
    """
    return [
        {"gl_account_number": "1111", "gl_account_name": "現金", "account_type": "Asset", "fs_caption": "現金及び預金"},
        {"gl_account_number": "1131", "gl_account_name": "売掛金", "account_type": "Asset", "fs_caption": "売掛金"},
        {"gl_account_number": "2121", "gl_account_name": "買掛金", "account_type": "Liability", "fs_caption": "買掛金"},
        {"gl_account_number": "4111", "gl_account_name": "売上高", "account_type": "Revenue", "fs_caption": "売上高"},
        {"gl_account_number": "5111", "gl_account_name": "売上原価", "account_type": "Expense", "fs_caption": "売上原価"},
        {"gl_account_number": "5999", "gl_account_name": "雑費", "account_type": "Expense", "fs_caption": "販管費"},
    ]
